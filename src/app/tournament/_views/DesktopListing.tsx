...
export function DesktopListing({
  type,
  tournament,
  golfer,
  userTeam,
  ...
  return (
    ...
    >
      <div
        className={cn(
          "grid-cols-16 grid grid-flow-row py-0.5",
          type === "PGC" &&
      ...
      >
        ...
        <div className="col-span-5 place-self-center font-varela text-lg">
...
function PGADropdown({
  ...
  return (
    <div
      className={cn(
        "grid-cols-14 col-span-10 mb-2 grid pt-1",
      ...
      <div className="col-span-10 mb-4 mt-2 w-full">
        <Table className="scrollbar-hidden mx-auto w-full border border-gray-700 text-center font-varela">
          <TableRow className="bg-gray-700 font-bold text-gray-100 hover:bg-gray-700">
            ...
            <td className="px-0.5 text-2xs">Usage</td>
