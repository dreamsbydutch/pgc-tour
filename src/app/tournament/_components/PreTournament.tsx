...
export default function PreTournamentPage({
  ...
  return (
    <div>
      ...
      {/* <TeamPickForm {...{ member, tourCard, tournament, teamGolfers }} /> */}
...
function TeamPickForm({
  ...
  return (
    <div className="mx-auto mb-4 w-fit max-w-4xl rounded-lg border border-slate-400 bg-slate-100 px-6 py-2 text-center shadow-xl">
      ...
      {member.account > 0 && (
        <div className="mx-auto mb-8 w-5/6 text-center text-lg italic text-red-600">{`Please send ${formatMoney(member.account)} to puregolfcollectivetour@gmail.com before making your picks.`}</div>
      )}
...
function TeamTeeTimes({
  ...
  return (
    <>
      <div className="pt-4 text-center text-2xl font-bold">Your Tee Times</div>
